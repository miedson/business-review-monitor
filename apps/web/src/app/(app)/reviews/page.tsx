...
export default function ReviewsPage() {
  ...
  const visible = useMemo(() => reviews.filter((review) => (review.reviewerName ?? "").toLowerCase().includes(query.toLowerCase()) && score(review.starRating) >= minimum && (replyFilter === "ALL" || (replyFilter === "PENDING" ? !hasReply(review) : hasReply(review)))), [reviews, query, minimum, replyFilter]);
