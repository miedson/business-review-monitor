...
import { Box, Button, Text, Flex, Badge } from "@/lib/design-system";
  ...
  return (
    <Box css={{ minH: "100vh", bg: "surface.secondary", px: 4, py: 8 }}>
      <Box css={{ maxW: "600px", mx: "auto", textAlign: "center" }}>
        ...
        >
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" xmlns="http://www.w3.org/2000/svg">
        ...
        <Text fontSize="lg" color="text.tertiary" mb={8} maxW="500px" mx="auto" lineHeight="relaxed">
          {anyConnected
        ...
        <Box css={{ display: "flex", flexDirection: "column", gap: 4, mb: 8, maxW: "400px", mx: "auto", textAlign: "left" }}>
          <Box css={{ display: "flex", alignItems: "center", gap: 4, p: 4, bg: "surface.primary", border: "1px solid", borderColor: googleConnected ? "status.success.border" : "surface.border", borderRadius: "2xl" }}>
            ...
            <Box css={{ flex: 1, textAlign: "left" }}>
              <Text fontWeight="semibold" color="text.primary">Google Business Profile</Text>
              {googleConnected ? (
                <Flex css={{ alignItems: "center", gap: 2 }}>
                  <Badge variant="success" size="sm">Conectado</Badge>
                  {googleAccount && <Text fontSize="sm" color="text.tertiary">{googleAccount}</Text>}
                </Flex>
              ) : (
                <Badge variant="subtle" colorScheme="gray" size="sm">Não conectado</Badge>
              )}
            </Box>
          </Box>
          ...
          <Box css={{ display: "flex", alignItems: "center", gap: 4, p: 4, bg: "surface.primary", border: "1px solid", borderColor: instagramConnected ? "status.success.border" : "surface.border", borderRadius: "2xl" }}>
            ...
            <Box css={{ flex: 1, textAlign: "left" }}>
              <Text fontWeight="semibold" color="text.primary">Instagram</Text>
              {instagramConnected ? (
                <Flex css={{ alignItems: "center", gap: 2 }}>
                  <Badge variant="success" size="sm">Conectado</Badge>
                  {instagramAccount && <Text fontSize="sm" color="text.tertiary">@{instagramAccount}</Text>}
                </Flex>
              ) : (
                <Badge variant="subtle" colorScheme="gray" size="sm">Não conectado</Badge>
              )}
          ...
          <Box css={{ display: "flex", alignItems: "center", gap: 4, p: 4, bg: "surface.primary", border: "1px solid", borderColor: "surface.border", borderRadius: "2xl", opacity: 0.5 }}>
            ...
            <Box css={{ flex: 1, textAlign: "left" }}>
              <Text fontWeight="semibold" color="text.quaternary">Facebook</Text>
              <Badge variant="subtle" colorScheme="amber" size="sm">Em breve</Badge>
            </Box>
          </Box>
        </Box>
