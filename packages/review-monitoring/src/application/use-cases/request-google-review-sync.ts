...
export class RequestGoogleReviewSync {
  constructor(private readonly dependencies: RequestGoogleReviewSyncDependencies) {}

  async execute(input: RequestGoogleReviewSyncInput): Promise<RequestGoogleReviewSyncResult> {
